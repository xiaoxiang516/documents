...
function getPageEnties (pageFiles) {
    ...
    let entryPages = [
        ...
        // 'kTwoApproval.html',
        // 'msgCenter.html',
        'personalWork/index.html',
        'operation/index.html',
        'supplier/index.html',
        // 'standards/index.html',
        // 'productInno/index.html',
        'system/index.html',
        'report/index.html',
        // 'techSpecification/index.html',
        'task/index.html',
        // 'harvestLibrary/index.html',
        // 'designReview/index.html',
        // 'designChange/index.html',
        // 'drawingDistribution/index.html',
        // 'nodeTemplate/index.html',
        // 'contactLetter/index.html',
        // 'designInspection/index.html',
        // 'news/index.html',
        // 'limitTemplate/index.html',
        // 'developManage/index.html',
        // 'stationedService/index.html',
        // 'drawingExternal/index.html',
        // 'groundBaseInfo/index.html',
        'charts/index.html',
        // 'designExplanation/index.html',
        // 'carouselManage/index.html',
        'patrol/index.html',
        'inspectionDocument/index.html',
        // 'showReceiveApply/index.html',
        // 'outsourcing/index.html',
        // 'partnerProject/index.html',
        // 'OutsourcingRequestInstructionsPlaceOnFile/index.html'
    ]

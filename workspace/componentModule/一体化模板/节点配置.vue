    ...
    <div>
      ...
      >
        <template #checkbox="{ row, column, $index }">
          <el-checkbox :disabled="!isEdit" size="large" v-model="row[column['rawColumnKey']]"></el-checkbox>
        </template>
<!--        <template #checkbox1="{ row, column, $index }">-->
<!--          <el-checkbox :disabled="!isEdit" size="large" v-model="row.innerNetRegister"></el-checkbox>-->
<!--        </template>-->
<!--        <template #checkbox2="{ row, column, $index }">-->
<!--          <el-checkbox :disabled="!isEdit" size="large" v-model="row.infoCheck"></el-checkbox>-->
<!--        </template>-->
<!--        <template #checkbox3="{ row, column, $index }">-->
<!--          <el-checkbox :disabled="!isEdit" size="large" v-model="row.inspect"></el-checkbox>-->
<!--        </template>-->
<!--        <template #checkbox4="{ row, column, $index }">-->
<!--          <el-checkbox :disabled="!isEdit" size="large" v-model="row.admittance"></el-checkbox>-->
<!--        </template>-->
<!--        <template #checkbox5="{ row, column, $index }">-->
<!--          <el-checkbox :disabled="!isEdit" size="large" v-model="row.frameworkAgreement"></el-checkbox>-->
<!--        </template>-->
      </TableTree>
    </div>
...
const submit = async (formEl: FormInstance | undefined) => {
  ...
  isEdit.value = false;
  await api.saveStorageNodeConfig(tableData.value).then(res => {
